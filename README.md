# 日本語 prototype_keyboard_Low64_16mm

github prototype_keyboard_Low64_16mm
...
このキーボードは英語配列キーボードに無変換(英数) 変換(かな)を付けた、日本語環境でUSキーボードを使う人にとって、欲しかった機能を付けた商品です。
...
非常にボタンの押し心地が良い Lofree Liner 軸を採用
